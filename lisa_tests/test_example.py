...
# this example:
# https://tooling.sites.arm.com/lisa/latest/
#
...
class ExampleTestBundle(RTATestBundle, TestBundle):
    ...
    def _from_target(cls, target: Target, *, res_dir: ArtifactPath, collector=None): #-> 'ExampleTestBundle':
        ...
        **All other parameters are keyword-only**
        ...
        """
        # PlatformInfo
        # https://tooling.sites.arm.com/lisa/latest/target.html#lisa.platforms.platinfo.PlatformInfo
        #
        ...
        with target.cpufreq.use_governor("schedutil"):
            ...
            # https://tooling.sites.arm.com/lisa/latest/kernel_tests.html#lisa.tests.base.RTATestBundle.run_rtapp
            #
    ...
    def _get_rtapp_profile(cls, plat_info):
        ...
        # https://tooling.sites.arm.com/lisa/latest/workloads.html
        profile = {}
    ...
    def test_output(self, util_margin=50) -> ResultBundle:
        ...
        # https://tooling.sites.arm.com/lisa/latest/trace_analysis.html
