...
class CameraPreviewTest(LisaBenchmark):

    # Android Workload to run
    bm_name = 'CameraPreview'
    ...
    def __init__(self, governor, duration_s):
        self.governor = governor
        self.duration_s = duration_s
        super(CameraPreviewTest, self).__init__()
...
for governor in governors:
    try:
        CameraPreviewTest(governor, duration_s)
        tests_completed += 1
    except:
