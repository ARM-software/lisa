...
a53_cluster_active_states = OrderedDict([
    (450045, ActiveState(power=26)),
    (575043, ActiveState(power=30)),
    (699790, ActiveState(power=39)),
    (775193, ActiveState(power=47)),
    (850340, ActiveState(power=57)),
])
...
a53_cpu_active_states = OrderedDict([
    (450045, ActiveState(capacity=235, power=33)),
    (575043, ActiveState(capacity=302, power=46)),
    (699790, ActiveState(capacity=368, power=61)),
    (775193, ActiveState(capacity=406, power=76)),
    (850340, ActiveState(capacity=447, power=93)),
])
...
a57_cluster_active_states = OrderedDict([
    ( 450045, ActiveState(power=24)),
    ( 625000, ActiveState(power=32)),
    ( 800000, ActiveState(power=43)),
    ( 949667, ActiveState(power=49)),
    (1100110, ActiveState(power=64)),
])
...
a57_cpu_active_states = OrderedDict([
    (450045,  ActiveState(capacity=417,   power=168)),
    (625000,  ActiveState(capacity=579,   power=251)),
    (800000,  ActiveState(capacity=744,   power=359)),
    (949667,  ActiveState(capacity=883,   power=479)),
    (1100110, ActiveState(capacity=1023,  power=616)),
])
